...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl">
                Intelligent Recieipt Scanning
              </h1>
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                Scan, analyze and organize your receipts with AI-powered
                precision. Save time and gain insights of your expenses.
              </p>
            </div>
      ...
      {/* features */}
      <section id="features" className="py-16 md:p-24">
        <div className="container px-4 md:px-2 mx-auto">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter md:text-xl">
                Powerful Features
              </h2>
        ...
        <div className="container px-4 md:px-6 mx-auto">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[700px] text-gray-400 dark:text-gray-400 md:text-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 mx-auto">
            ...
            <div className="flex flex-col p-6 bg-blue-50 border border-blue-200 rounded-lg relative dark:border-blue-900 dark:bg-blue-900/20">
              <span className="absolute -top-3 right-4 bg-blue-600 text-white px-3 py-1 rounded-full text-sm font-medium">
                Popular
              </span>
